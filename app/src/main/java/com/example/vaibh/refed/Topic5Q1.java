...
public class Topic5Q1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.topic5_q1);
        ...
        btnHint.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Toast.makeText(getApplicationContext(),getString(R.string.hint13) , Toast.LENGTH_LONG).show();
            }
        ...
        {
            pic.setImageResource(R.drawable.topic5q1_pic_ar);
        }
        else
        {
            pic.setImageResource(R.drawable.topic5q1_pic);
        }
