...
public class Topic14Vid3 extends AppCompatActivity {

    private Context c = Topic14Vid3.this;
    private Button cont;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.topic14_vid3);
    ...
    {
        int video = R.raw.sv_part2_mul_div_fractions;
        if (lang.equals("Arabic"))
        {
            video = R.raw.sv_part2_mul_div_fractions_ar;
        }
