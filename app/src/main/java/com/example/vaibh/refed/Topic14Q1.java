...
public class Topic14Q1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.topic14_q1);
        ...
        btnHint.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Toast.makeText(getApplicationContext(),getString(R.string.hint41) , Toast.LENGTH_LONG).show();
            }
