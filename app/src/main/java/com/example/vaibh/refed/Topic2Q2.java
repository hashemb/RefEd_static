...
public class Topic2Q2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.topic2_q2);
        ...
        btnHint.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Toast.makeText(getApplicationContext(),getString(R.string.hint5) , Toast.LENGTH_LONG).show();
            }
        ...
        if (lang != null && lang.equals("Arabic"))
        {
