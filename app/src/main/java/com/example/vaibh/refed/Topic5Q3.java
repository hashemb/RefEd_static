...
public class Topic5Q3 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.topic5_q3);
        ...
        btnHint.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Toast.makeText(getApplicationContext(),getString(R.string.hint15) , Toast.LENGTH_LONG).show();
            }
        ...
        {
            pic.setImageResource(R.drawable.topic5q3_pic_ar);
        }
        else
        {
            pic.setImageResource(R.drawable.topic5q3_pic);
        }
