...
public class Topic9Vid1 extends AppCompatActivity {

    private Context c = Topic9Vid1.this;
    private Button cont;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.topic9_vid1);
    ...
    {
        int video = R.raw.sv_part1_simplyfing_fractions;
        if (lang.equals("Arabic"))
        {
            video = R.raw.sv_part1_simplyfing_fractions_ar;
        }
