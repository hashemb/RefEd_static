...
public class Topic11Vid1 extends AppCompatActivity {

    private Context c = Topic11Vid1.this;
    private Button cont;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.topic11_vid1);
    ...
    {
        int video = R.raw.sv_part1_percents;
        if (lang.equals("Arabic"))
        {
            video = R.raw.sv_part1_percents_ar;
        }
