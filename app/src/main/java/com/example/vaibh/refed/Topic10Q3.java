...
public class Topic10Q3 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.topic10_q3);
        ...
        btnHint.setOnClickListener(new View.OnClickListener()
        {
            @Override public void onClick(View v)
            {
                ...
                imageView.setImageResource(R.drawable.hint31);
        ...
        {
            pic.setImageResource(R.drawable.topic10q3_pic_ar);
        }
        else
        {
            pic.setImageResource(R.drawable.topic10q3_pic);
        }
        ...
        checkbtn.setOnClickListener(new View.OnClickListener()
        {
            @Override public void onClick(View v)
            {
                if (entry1.getText().toString().equals("20"))
                {
                    // Correct Answer!!!
