...
public class Topic28Q3 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.topic28_q3);
        ...
        btnHint.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Toast.makeText(getApplicationContext(),getString(R.string.hint72) , Toast.LENGTH_LONG).show();
            }
        ...
        {
            pic.setImageResource(R.drawable.topic28q3_pic_ar);
        }
        else
        {
            pic.setImageResource(R.drawable.topic28q3_pic);
        }
        ...
        checkbtn.setOnClickListener(new View.OnClickListener()
        {
            @Override public void onClick(View v)
            {
                if (entry1.getText().toString().equals("42"))
                {
