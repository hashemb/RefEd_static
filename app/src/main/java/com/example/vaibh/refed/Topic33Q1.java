...
public class Topic33Q1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.topic33_q1);
        ...
        btnHint.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Toast.makeText(getApplicationContext(),getString(R.string.hint86) , Toast.LENGTH_LONG).show();
            }
        ...
        {
            pic.setImageResource(R.drawable.topic33q1_pic_ar);
        }
        else
        {
            pic.setImageResource(R.drawable.topic33q1_pic);
        }
