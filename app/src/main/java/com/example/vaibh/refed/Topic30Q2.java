...
public class Topic30Q2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.topic30_q2);
        ...
        btnHint.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Toast.makeText(getApplicationContext(),getString(R.string.hint79) , Toast.LENGTH_LONG).show();
            }
