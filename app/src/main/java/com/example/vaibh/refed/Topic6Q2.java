...
public class Topic6Q2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.topic6_q2);
        ...
        btnHint.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Toast toast = Toast.makeText(getApplicationContext(), getString(R.string.hint17), Toast.LENGTH_SHORT);
            }
        ...
        {
            pic.setImageResource(R.drawable.topic6q2_pic_ar);
        }
        else
        {
            pic.setImageResource(R.drawable.topic6q2_pic);
        }
