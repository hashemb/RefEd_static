...
public class Topic14Vid1 extends AppCompatActivity {

    private Context c = Topic14Vid1.this;
    private Button cont;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.topic14_vid1);
    ...
    {
        int video = R.raw.sv_part2_mult_decimals;
        if (lang.equals("Arabic"))
        {
            video = R.raw.sv_part2_mult_decimals_ar;
        }
