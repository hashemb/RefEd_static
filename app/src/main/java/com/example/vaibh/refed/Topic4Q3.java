...
public class Topic4Q3 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.topic4_q3);
        ...
        btnHint.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Toast.makeText(getApplicationContext(),getString(R.string.hint12) , Toast.LENGTH_LONG).show();
            }
        ...
        final String ans2 = entry2.getText().toString();
        ...
        {
            pic.setImageResource(R.drawable.topic4q3_pic_ar);
        }
        else
        {
            pic.setImageResource(R.drawable.topic4q3_pic);
        }
        ...
        checkbtn.setOnClickListener(new View.OnClickListener()
        {
            @Override public void onClick(View v)
            {
                if (entry1.getText().toString().equals("12"))
                {
